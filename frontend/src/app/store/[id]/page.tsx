...
export default function EditStoreAccountPage() {
  ...
  const handleDelete = async () => {
    if (!store) return;
    if (!window.confirm(`Delete "${store.storeName}"? This cannot be undone.`))
      return;
    try {
  ...
  const handleRegenerate = async () => {
    ...
    if (
      !window.confirm(
        "Regenerate the API key for this store? The old key will stop working.",
      )
    )
      return;
              ...
              <div className="page-header">
                <div>
                  ...
                  <div className="page-subtitle">
                    Update the name of your store account.
                  </div>
                </div>
              </div>
            ...
            <>
              <div className="page-header">
                <div>
                  ...
                  <div className="page-subtitle">
                    Treat this key like a password. Share it only with your
                    server.
                  </div>
                </div>
                <button
              ...
              {store.secretKey ? (
                ...
                >
                  ...
                  <p className="text-muted text-sm">
                    Regenerating the key immediately invalidates the previous
                    one.
                  </p>
                </div>
              ) : (
                ...
                >
                  ...
                  <p className="text-sm mt-1">
                    Click Regenerate Key to create one.
                  </p>
                </div>
              )}
            </>
          ...
          {activeSection === "danger" && (
            <>
              ...
              >
                ...
                >
                  <div>
                    <p style={{ fontWeight: 700, color: "var(--clr-danger)" }}>
                    ...
                    >
                      Once deleted, all data associated with this store will be
                      permanently removed.
                    </p>
                  </div>
